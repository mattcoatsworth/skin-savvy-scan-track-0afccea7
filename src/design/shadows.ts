...
export const shadows = {
  ...
  components: {
    ...
    activeCard: 'shadow-md', // Card that is active or hovered
    button: 'shadow-sm', // Default button shadow
    activeButton: 'shadow-md', // Button when pressed
    modal: 'shadow-xl', // Modal dialog shadow
    dropdown: 'shadow-lg', // Dropdown menu shadow
    tooltip: 'shadow-md' // Tooltip shadow
  },
  
  // Hover and interaction states
  interactive: {
    hover: '0 4px 10px rgba(0, 0, 0, 0.08)',
    active: '0 2px 5px rgba(0, 0, 0, 0.05)'
  }
};
