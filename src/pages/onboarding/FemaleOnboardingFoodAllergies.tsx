...
const FemaleOnboardingFoodAllergies: React.FC = () => {
  const navigate = useNavigate();
  const form = useForm<FoodAllergiesFormValues>({
    defaultValues: {
      allergies: [],
      otherAllergy: "",
    },
  ...
  const onSubmit = (data: FoodAllergiesFormValues) => {
    ...
    localStorage.setItem("userFoodAllergies", JSON.stringify(allAllergies));
    
    // Navigate to the next screen
    navigate("/onboarding/female/product-allergies");
  };
  ...
  return (
    <OnboardingTemplate
      title="Are you allergic to any foods?"
...
export default FemaleOnboardingFoodAllergies;
